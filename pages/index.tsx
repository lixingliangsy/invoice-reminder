  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://invoice-reminder.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is Dunner?", "acceptedAnswer": {"@type": "Answer", "text": "A tool that writes 3 professional reminder emails to chase late invoices from a client, amount, and days overdue."}}, {"@type": "Question", "name": "How many reminders do I get?", "acceptedAnswer": {"@type": "Answer", "text": "It returns 3 ready-to-send emails with built-in escalation."}}, {"@type": "Question", "name": "Can I pick the tone?", "acceptedAnswer": {"@type": "Answer", "text": "It offers 3 tones so you match the client relationship while staying professional."}}, {"@type": "Question", "name": "Are they ready to send?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. The copy is copy-ready to send as-is."}}, {"@type": "Question", "name": "What do I need to enter?", "acceptedAnswer": {"@type": "Answer", "text": "A client, the amount, days overdue, and a tone."}}, {"@type": "Question", "name": "Who should use Dunner?", "acceptedAnswer": {"@type": "Answer", "text": "Freelancers and small shops who want to collect late payments without the awkwardness."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Dunner - definition</h2>
