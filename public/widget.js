 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="invoice-reminder" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "invoice-reminder";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "invoice-reminder") + "_chat_session";
