...
export const PIPELINE_ID = 'invoice-reminder-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Client, amount, days overdue",
  process: "Step 2/3 · Pick tone & escalate",
  output: "Step 3/3 · 3 ready reminder emails",
}
